...
export function CSSShield() {
  useEffect(() => {
    // 动态注入CSS样式
    const styleId = "css-shield-styles";
    ...
    style.textContent = `
      ...
      .css-shield-main {
        ...
        animation: css-shield-rotate 20s linear infinite;
      }
      ...
      .css-shield-core {
        ...
        box-shadow:
          ...
          0 0 40px #00f5ff,
          0 0 60px #00f5ff;
        animation: css-core-pulse 3s ease-in-out infinite;
      }
      ...
      .css-shield-hex {
        ...
        opacity: 0.6;
        animation: css-hex-glow 4s ease-in-out infinite;
      }
      ...
      .css-energy-ring {
        ...
        opacity: 0.4;
        transform: translate(-50%, -50%);
        animation: css-ring-pulse 6s ease-in-out infinite;
      }
      ...
      .css-orb {
        ...
        animation: css-orb-orbit 8s linear infinite;
      }
      ...
      .css-glow-bg {
        ...
        transform: translate(-50%, -50%);
        animation: css-bg-pulse 8s ease-in-out infinite;
      }
